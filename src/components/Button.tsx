...
const Button: React.FC<ButtonProps> = ({ text, targetId }) => {
  ...
  return (
    ...
    >
      ...
      <div className="w-11 h-11 bg-primary flex items-center justify-center rounded-xl transition-all duration-300 group-hover:rotate-12">
        <RiShakeHandsFill className="text-white text-xl transition-transform duration-300" />
      </div>
    </button>
  );
};
