  ...
  return (
    <div className="py-32 md:py-48 lg:py-60 relative z-0 overflow-x-clip">
      ...
      <HeroOrbit size={720} rotation={85}>
        <div className="size-3 rounded-full bg-magenta/50" />
      </HeroOrbit>
      <HeroOrbit size={520} rotation={-41}>
        <div className="size-2 rounded-full bg-magenta/50" />
      </HeroOrbit>
      ...
      <div className="max-w-lg mx-auto">
          <h1 className="font-secondary text-3xl md:text-5xl text-center mt-8 tracking-wide">Building Exceptional User Experiences</h1>
          <p className="mt-4 text-center text-dark/60 md:text-lg">
            We specialize in transforming designs into functional, high-performing 
